...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layout_limit = QHBoxLayout()
        self.label_limit = QLabel("FILE SIZE (MB)")
        self.label_limit.setFont(fontBody)
        self.size_limit_input = QLineEdit()
        self.size_limit_input.setFont(fontBody)
        self.size_limit_input.setPlaceholderText("Mặc định: 35 MB")
        self.layout_limit.addWidget(self.label_limit)
        self.layout_limit.addWidget(self.size_limit_input)
        self.verticalLayout.addLayout(self.layout_limit)
